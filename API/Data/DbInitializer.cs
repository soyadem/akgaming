    ...
    private static void SeedData(StoreContext context)
    {
        ...
        var products = new List<Product>
        {
                   new()
                {
                    ...
                    Price = 349,
                    PictureUrl = "/images/products/valorant.jpg",
                ...
                new()
                {
                    ...
                    Price = 119,
                    PictureUrl = "/images/products/bloodborne.jpg",
                ...
                new()
                {
                    ...
                    Price = 249,
                    PictureUrl = "/images/products/tlou2.jpg",
                ...
                new() 
                {
                    ...
                    Price = 449,
                    PictureUrl = "/images/products/wukong.jpg",
                ...
                new() 
                {
                    ...
                    Price = 199,
                    PictureUrl = "/images/products/sifu.jpg",
                ...
                new() 
                {
                    ...
                    Price = 349,
                    PictureUrl = "/images/products/clair.jpg",
                ...
                new() 
                {
                    ...
                    Price = 299,
                    PictureUrl = "/images/products/oblivion.jpg",
                ...
                new() 
                {
                    ...
                    Price = 499,
                    PictureUrl = "/images/products/forza.jpg",
